...
// and parses it.
func (dkim *dkim) NewPubKeyRespFromDNS(selector, domain string, opts ...DNSOpt) (*PubKeyRep, VerifyOutput, error) {
	dnsOpts := DNSOptions{}
	...
	if dnsOpts.netLookupTXT == nil {
		if dkim.lookupTXT != nil {
			dnsOpts.netLookupTXT = dkim.lookupTXT
		} else {
